...
#
#
CONFIG_FILES=( PAUL* vadmin-custom* conf/custom_* includes/custom_* includes/vadmin_functions.inc.* conf/recommended* conf/apache.conf conf/sql.conf.php conf/vadmin.conf.php conf/vmailmgr.conf.php includes/suid/Makefile includes/suid/vadmin_auth.o includes/suid/vadmin_storage_gdbm.o includes/suid/checkcreds_cclient.o includes/suid/checkcreds_imap.o includes/suid/imap-20* includes/suid/imap.tar.Z )
